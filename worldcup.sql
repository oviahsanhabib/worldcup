...
--
-- Name: games_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.games_seq OWNED BY public.games.game_id;
...
--
-- Name: team_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--
...
ALTER TABLE public.team_seq OWNER TO freecodecamp;

--
-- Name: team_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.team_seq OWNED BY public.teams.team_id;
...
ALTER TABLE ONLY public.games ALTER COLUMN game_id SET DEFAULT nextval('public.games_seq'::regclass);
...
ALTER TABLE ONLY public.teams ALTER COLUMN team_id SET DEFAULT nextval('public.team_seq'::regclass);
...
SELECT pg_catalog.setval('public.games_seq', 32, true);


--
-- Name: team_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.team_seq', 61, true);
...
--
-- Name: games fk_oponent_id; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.games
    ADD CONSTRAINT fk_oponent_id FOREIGN KEY (opponent_id) REFERENCES public.teams(team_id);
